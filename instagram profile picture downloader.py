...
win = tk.Tk()
win.title('Instagram Profile Picture Downloader')
...
def imgDownload():
    ...
    messagebox.showinfo("Status", "Profile Picture Downloaded Succesfully")
...
title = tk.Label(win, text="Instagram Profile Picture Downloader", font=("Times", 20, "bold"))
